...
namespace CMS.Api.Routing
{
    ...
    public class UserRouting : RoutingBase<AspNetUsers, IUserRepository>, IUserRouting
    {
        ...
        //protected UserRouting(WebApplication app, IUserRepository repository,UserManager<ApplicationUser> userManager,
        // SignInManager<ApplicationUser> signInManager) :this(app,repository)
        //{
        ...
        public override async Task MapAll()
        {
                ...
                SignInManager<ApplicationUser> signInManager) =>
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    response.Token = jwtUtils.GenerateJwtToken(response);
